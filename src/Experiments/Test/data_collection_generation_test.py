...
#logging.disable()
sepa = OptimalCut(write_cgf_data=True, cgp_kwds={"algorithm" : "bkpt_as_param", "cut_score": cut_score_name , "epsilon":1/16, "M":1e6, "max_num_of_bkpts": num_bkpts, "backend":"pplite", "enable_profiling":profile, "backend_kwds":{"sage_mip":{"solver":"GLPK"}}})
